    ...
    >
      ...
      <form>
          ...
          <div className=''>
            ...
            <div className='flex w-full justify-center items-center space-x-6'>
              <input 
                ...
                max="400000"
                required
                className='w-full px-4 py-2 tex-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center'
              />
              {type === "rent" && (
                <div className=''>
        ...
        <div className='mb-6'>
          ...
          <p className='text-grat-600'>The First Image Will be the Cove (max 6) </p>
          <input 
            type='file'
            id='images'
            onChange={onchange}
            ...
            multiple
            required
            className='w-full px-3 py-1.5 text-gray-700 bg-white border border-gray-300 rounded trnsition duration-150 ease-in-out focus:bg-white focus:border-slate-600 '
          />
        </div>
