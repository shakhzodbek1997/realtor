...
function ForgotPassword() {
  ...
  return (
    <section>
      <h1 className="text-3xl text-center mt-6 font-bold x">Forgot Password </h1>
          ...
          <form onSubmit={onSubmit}>
            ...
            <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg">
              <p className="mb-6">
                ...
                <Link
                  to="/sign-in"
                  className="text-red-600 hover:text-red-700 transition duration-200 ease-in-out ml-1 font-medium"
                >
                  Register 
                </Link>
              </p>
            ...
            <button
              className="w-full bg-blue-600 text-white px-7 py-3 rounded text-sm font-medium uppercase shadow-md hover:bg-blue-700 transition duration-200 ease-in-out hover:shadow-lg active:bg-blue-800"
              type="submit"
            >
              Send reset password
            </button>
